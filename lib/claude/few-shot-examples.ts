...
export const EXAMPLE_AT_OUTPUT = {
  ...
  conclusoes:
    "No decurso das diligências realizadas para a boa instrução do processo, apurou-se que o sinistro participado ocorreu em 16/03/2026, pelas 09h00, na Rua de Camões 17, em Odiáxere, durante a execução de tarefas de reboco num pilar à entrada de uma habitação. O sinistrado, José Carlos Alves da Glória, descreveu que, ao baixar-se no decurso do trabalho, sentiu uma dor aguda na região posterior do joelho direito. Foi confirmado o vínculo laboral activo do sinistrado com o tomador desde 20/02/2018, na categoria profissional de pedreiro de 1.ª, com vencimento base mensal de €958,00, conforme recibos juntos em anexo. Foi confirmada a entrada do sinistrado no Serviço de Urgência do Hospital do Barlavento, em 16/03/2026, sob o episódio n.º 86067816, com alta hospitalar no próprio dia, e o subsequente acompanhamento na Clínica de São Gonçalo (Grupo HPA Saúde, episódio n.º 426817), com atribuição de Incapacidade Temporária Absoluta até 02/04/2026. Foi efectuada visita ao local do sinistro em 21/04/2026, tendo sido recolhida reportagem fotográfica e observadas as características do espaço. Foram recolhidas declarações escritas e verbais do sinistrado, conforme exposto na secção 9. Encontra-se pendente o envio do relatório de urgência hospitalar, solicitado por correio electrónico junto do Hospital do Barlavento, cujo aditamento ficará dependente da sua recepção. Não foi recebida qualquer resposta do tomador do seguro às diligências documentais efectuadas, conforme detalhado na secção 11.2, não tendo sido remetida documentação relativa às condições de Segurança e Saúde no Trabalho. Foram identificadas no decurso da averiguação divergências parciais no relato do sinistrado, designadamente quanto à identificação da pessoa que terá prestado auxílio imediato após o evento, conforme detalhado na secção 11.4. Damos, assim, por terminada a nossa intervenção no presente processo, ficando ao dispor desta Companhia de Seguros para a realização de diligências complementares que entendam por convenientes, designadamente caso venha a ser disponibilizada documentação clínica adicional ou resposta do tomador do seguro.",
...
export const EXAMPLE_AUTO_OUTPUT = {
  ...
  danosSeguro: {
    intro:
      "Da análise presencial ao Veículo Seguro (Dacia Duster, matrícula BZ-36-QD), constatámos danos no para-choques frontal, nomeadamente:\n\n✓ Lateral esquerda do para-choques: plásticos partidos e escoriações superficiais;\n\n✓ Pintura da lateral esquerda: deformações da chapa com riscos lineares horizontais;\n\n✓ Elementos plásticos inferiores do para-choques: ligeiro desencaixe, sem rotura estrutural.",
    altimetria:
      "Danos com altimetria: 35 a 57 cm na face lateral esquerda do para-choques (plásticos partidos) e 49 a 73 cm na pintura da lateral esquerda do veículo (deformações da chapa).",
    reparador: "AutoOne",
    ipo: "[a confirmar]",
  },
  danosTerceiro: {
    intro:
      "Da análise presencial ao Veículo Terceiro (Citroen Saxo, matrícula 75-96-RO), foram observados danos na zona frontal, nomeadamente:\n\n✓ Para-choques dianteiro: deformação acentuada, rotura e desencaixe de componentes;\n\n✓ Grelha frontal: partida;\n\n✓ Capot: deformação acentuada;\n\n✓ Grupos ópticos: comprometidos, com exposição de elementos internos.",
    altimetria:
      "Danos com altimetria: desde a base do para-choques (~30 cm) até à zona do capot (~80 cm), em zona frontal completa do veículo.",
  ...
  conclusoes:
    "No decurso das diligências realizadas para a boa instrução do processo, apurou-se que o sinistro consistiu numa colisão ocorrida em 03/04/2026, pelas 18h15, na Rua António Dias dos Santos, em Grândola, num cruzamento em zona urbana, sem sinalização vertical ou horizontal reguladora de prioridade. O veículo seguro, conduzido pela Sra. Luana Isabel Aniceto Garcia, executava manobra de mudança de direcção à esquerda para ingressar na referida artéria. Em simultâneo, o veículo terceiro, conduzido pelo Sr. Bruno Miguel Bacalhau Costa, executava manobra de mudança de direcção à direita para a mesma via. As trajectórias de ambos os veículos convergiram no interior do cruzamento, tendo ocorrido colisão entre a zona frontal-esquerda do veículo seguro e a zona frontal do veículo terceiro. Foi efectuada deslocação ao local do sinistro em 08/04/2026, tendo sido recolhida reportagem fotográfica e identificados vestígios físicos do embate (plásticos e estilhaços de vidro). Foram recolhidas declarações escritas e verbais do CVS, do CVT e das duas testemunhas presenciais identificadas, conforme exposto nas secções 9 a 11. Foi efectuada análise presencial aos danos materiais em ambos os veículos, conforme detalhado na secção 12. Foi confirmado, junto da GNR de Aljezur, que não existe qualquer registo policial associado às matrículas intervenientes, em conformidade com o relatado pelos intervenientes. Foi confirmado, junto da APS/Segurnet, que o veículo terceiro permaneceu sem apólice activa entre 28/05/2024 e 04/11/2025, situação justificada pelos intervenientes pela inactividade do veículo nesse período. A declaração amigável de acidente automóvel foi preenchida por terceira pessoa não identificada, residente nas proximidades, com a qual não foi possível restabelecer contacto. Damos, assim, por terminada a nossa intervenção no presente processo, ficando ao dispor desta Companhia de Seguros para a realização de diligências complementares que entendam por convenientes.",
